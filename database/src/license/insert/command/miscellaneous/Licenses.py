...
import json
import datetime
import database.src.license.insert.command.miscellaneous.Pagenation
import web.http.Response
class Licenses:
    def __init__(self, data):
        self.data = data
        self.page = database.src.license.insert.command.miscellaneous.Pagenation.Pagenation()
...
#        licenses += self.response.Get(r, type='json', success_code=200, sleep_time=2, is_show=True)
